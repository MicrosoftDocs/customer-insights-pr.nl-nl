...
Beheerders kunnen Customer Insights configureren om [een bestaande Dataverse-omgeving te gebruiken](create-environment.md) bij het maken van een Customer Insights-omgeving. Door de URL te verstrekken aan de Dataverse-omgeving, wordt het gekoppeld aan hun nieuwe Customer Insights-omgeving. Customer Insights en Dataverse-omgevingen moeten in dezelfde regio worden gehost. 
