...
Er zijn meerdere manieren om een nieuw segment te maken. In dit gedeelte wordt beschreven hoe u uw eigen segment helemaal opnieuw kunt opbouwen. U kunt ook een *snel segment* maken op basis van bestaande entiteiten of gebruikmaken van Machine Learning-modellen om *voorgestelde segmenten* te krijgen. Meer informatie: [Overzicht segmenten](segments.md)
...
1. Op de pagina voor het maken van segmenten definieert u de eerste regel. Een regel bestaat uit een of meer voorwaarden en definieert een set klanten.
...
1. Segmenten genereren standaard de entiteit voor uitvoer die alle kenmerken bevat van klantprofielen die overeenkomen met de gedefinieerde filters. Als een segment is gebaseerd op andere entiteiten dan de entiteit *Klant*, kunt u meer attributen van deze entiteiten aan de uitvoerentiteit toevoegen. Selecteer **Projectkernmerken** om de kenmerken te kiezen die aan de uitvoerentiteit worden toegevoegd.  
   ...
   > - U kunt alleen kenmerken projecteren van een entiteit die wordt gebruikt in elke regel van de segmentquery die u maakt.
...
1. Selecteer **Uitvoeren** om uw segment op te slaan en te verwerken als alle vereisten zijn gevalideerd. Anders wordt het segment opgeslagen als een inactief segmentconcept.
...
> - Als u meerdere regels voor uw segment hebt, wordt er een blauwe balk weergegeven rond de regel die u aan het bewerken bent.
...
> - Met de besturingselementen **Ongedaan maken** en **Opnieuw** op de opdrachtbalk kunt u wijzigingen ongedaan maken.
