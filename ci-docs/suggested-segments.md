---
title: Voorgestelde segmenten (preview)
...
Als gebruiker van Customer Insights heeft u waarschijnlijk een reeks [maatregelen gemaakt](measures.md) waarmee u uw KPI's (Key Performance Indicators) kunt volgen. Het is belangrijk te begrijpen hoe bepaalde kenmerken deze KPI beïnvloeden om segmenten te maken en een zeer gerichte campagne uit te voeren.   
