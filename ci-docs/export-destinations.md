...
- **Segmentexport** hiermee kunt u segmententiteiten exporteren uit Customer Insights. Segmenten vertegenwoordigen een lijst met klantprofielen. Bij het configureren van de export selecteert u de inbegrepen gegevensvelden, afhankelijk van het doelsysteem waarnaar u gegevens exporteert. 
